# The _dnssd_ interface

Here you can read about the `:dnssd` interface. This interface gives you access
to all of the DNS-SD interface. It will allow you to register, browse and resolve
